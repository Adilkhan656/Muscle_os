...
class RegisterScreen : AppCompatActivity() {
                ...
                viewModel.authState.collect { state ->
                    ...
                    when (state) {
                        ...
                        is AuthState.RegistrationSuccess -> {
                            ...
                            startActivity(
                                Intent(
                                    this@RegisterScreen, VerifyEmailActivity::class.java
                                )
                            )
                            finish()
                        }
                        ...
                        is AuthState.Error -> {
                            showLoading(false)
                            Toast.makeText(
                                this@RegisterScreen, state.message, Toast.LENGTH_SHORT
                            ).show()
                        }
    ...
    /**
     * configures focus listeners to provide visual feedback (elevation/border) when fields are active.
     */
    private fun setupFieldFocusStates() {
        ...
        fun updateFieldFocus() {
            ...
            val confirmPasswordFocused =
                binding.etConfirmPassword.hasFocus()
            ...
            binding.confirmPasswordField.elevation =
                if (confirmPasswordFocused) focusedElevation
                else 0f
        ...
        binding.confirmPasswordField.setOnClickListener {
    ...
    /**
     * Collects user input, validates it, and triggers the registration process.
     */
